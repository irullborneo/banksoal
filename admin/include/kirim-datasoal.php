<?php
	...
	switch($aksi){
		case "buat":
			...
			$guru=$_POST['guru'];
			if(empty($paket) || empty($pelajaran) || empty($guru)){
				echo "notice1";
			}
			else{
				...
				if($ceksoal==1){
					...
					if(mysql_query("INSERT INTO soal_pelajaran(id_paket_pelajaran, penulis, tgl_input, untuk) VALUES('$idpaketsoal[0]','$_SESSION[id_admin]','$date','ujian')")){
