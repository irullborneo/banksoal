...
<div class="row">
	<div class="col-sm-6 col-md-6">
		<h3 class="sub-header">Data Paket</h3>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#form-tambah-datapaket" id="tambah-datapaket-btn" >Tambah Data</button> 
        <button type="button" class="btn btn-primary" id="cetak-data-paket" data-toggle="modal" data-target="#cetak-datapaket">Cetak</button>
        ...
        <div id="status-hapusdata-paket" style="display:none">
			<strong id="sg-hapusdata-paket"></strong> : <span id="isi-hapusdata-paket"></span>
		</div>
        
        <div id="tmpat-paging-tblpaket"></div>
        
    </div>
    <div class="col-sm-6 col-md-6">
    	<h3 class="sub-header">Data Mata Pelajaran</h3>
        <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#form-tambah-datapelajaran" id="tambah-datapelajaran-btn" >Tambah Data</button> 
        <button type="button" class="btn btn-primary" id="cetak-data-pelajaran" data-toggle="modal" data-target="#cetak-datapelajaran">Cetak</button>
        <table class="table table-striped table-hover">
        	<thead>
            	<tr>
                	<th>#</th>
            ...
            <tbody id="tabel-matapelajaran">
            	
            </tbody>
        </table>
        <div id="status-hapusdata-pelajaran" style="display:none">
			<strong id="sg-hapusdata-pelajaran"></strong> : <span id="isi-hapusdata-pelajaran"></span>
		</div>
        
        <div id="tmpat-paging-tblpelajaran"></div>
    </div>
</div>

<h3 class="sub-header">Data Paket Pelajaran</h3>
