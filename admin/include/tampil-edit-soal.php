<?php
	...
	$id=$_GET['edit'];
	$edit=mysql_fetch_array(mysql_query("SELECT sp.id_soal_pelajaran, pp.id_paket, pp.id_pelajaran, pp.id_guru, sp.untuk FROM paket_pelajaran as pp, soal_pelajaran as sp WHERE pp.id_paket_pelajaran=sp.id_paket_pelajaran AND sp.id_soal_pelajaran=$id"));
?>
