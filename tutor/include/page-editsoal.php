...
<?php
	$ppguru=mysql_fetch_array(mysql_query("SELECT id_guru, sp.penulis FROM paket_pelajaran as pp, soal_pelajaran as sp WHERE sp.id_paket_pelajaran=pp.id_paket_pelajaran AND sp.id_soal_pelajaran='$_GET[edit]'"));
	if($ppguru[0]==$admin['id_guru'] || $ppguru[1]==$admin['id_guru']){
?>
