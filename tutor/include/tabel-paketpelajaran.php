<?php
	...
	$total=mysql_num_rows(mysql_query("SELECT * FROM paket_pelajaran as pp, guru as g, mata_pelajaran as mp, paket as p WHERE pp.id_paket=p.id_paket AND pp.id_pelajaran=mp.id_pelajaran AND pp.id_guru=g.id_guru AND g.id_sekolah='$admin[id_sekolah]' $strpilih"));
	...
	$querypaketpelajaran=mysql_query("SELECT pp.id_paket_pelajaran, p.paket, mp.mata_pelajaran, g.nama, pp.kkm FROM paket_pelajaran as pp, guru as g, paket as p, mata_pelajaran as mp WHERE pp.id_paket=p.id_paket AND pp.id_pelajaran=mp.id_pelajaran AND pp.id_guru=g.id_guru AND g.id_sekolah='$admin[id_sekolah]' $strpilih ORDER BY $kolom $urut limit $awal,$baris");
