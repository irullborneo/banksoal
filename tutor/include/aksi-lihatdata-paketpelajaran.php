<?php
	...
	$queryid=mysql_query("SELECT pp.id_paket, pp.id_pelajaran FROM paket_pelajaran as pp, guru as g WHERE id_paket_pelajaran=$idlihat AND pp.id_guru=g.id_guru AND g.id_sekolah='$admin[id_sekolah]'");
	    ...
	    <div class="modal-content">
          ...
          <div class="modal-body">
			<div class="container-fluid">
            	<?php
					$querybanyakguru=mysql_query("SELECT pp.id_guru, g.nama, pp.id_paket_pelajaran FROM paket_pelajaran as pp, guru as g WHERE pp.id_paket=$idpp[0] AND pp.id_pelajaran=$idpp[1] AND pp.id_guru=g.id_guru AND g.id_sekolah='$admin[id_sekolah]' GROUP BY pp.id_guru");
